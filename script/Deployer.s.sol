...
import {RegistryModuleOwnerCustom} from "../lib/ccip/contracts/src/v0.8/ccip/registryModuleOwnerCustom/RegistryModuleOwnerCustom.sol";
...
contract TokenAndPoolDeployer is Script {
    function run() public returns (RebaseToken, RebaseTokenPool) {
        ...
        vm.startBroadcast();
        RebaseToken token = new RebaseToken("RebaseToken", "RBT");
